...
*Двусвязный список*
*Преимущества:*
- Эффективное добавление и удаление элементов (O(1) при наличии указателя)
- Возможность обхода в обе стороны
...
4. Вывод результатов: При совпадении вывести заметку в табличном формате.
5. Завершение: Отобразить все найденные заметки или сообщение об отсутствии совпадений.
