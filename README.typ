...
[14], [Удаление заметки], [ID существующей заметки], [Уменьшение счетчика на 1], [PASSED],
[15], [Поиск по теме (найдено)], [Существующая тема], [Непустой вектор результатов], [PASSED],
[16], [Поиск по теме (не найдено)], [Несуществующая тема], [Пустой вектор результатов], [PASSED],
)
)
...
#pagebreak()
#ch("ПРИЛОЖЕНИЕ А. Листинги исходного кода")
